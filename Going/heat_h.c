...
int main(int argc, char *argv[])
{
  ...
  */
  for(l=1.;l<=floor(T/t);l++)                                                  //iteration for each timestep
  {
    ...
    sprintf (filename, "exact%.2f.txt", l);					                              //save data for every step
    ...
    */
    ...
    sprintf (filename, "sol%.2f.txt", l);					                              //save data for every step
  ...
  /*
  sprintf (filename, "norm_h.txt");					                              //save data for every step
